...
.. code-block:: python
    ...
    swaps = na_service.build_swaps("EUR PAY 10Y,USD REC 5Y")

Examples of other swap strings include:

* EUR PAY 10Y
* EUR REC 10Y
* EUR PAY 10Y ATM+0.005
* EUR PAY 10Y 0.035
* EUR PAY 10Y RFR
* EUR PAY 5Y10Y
* EUR PAY 1JAN49
* EUR PAY 1JAN191jan49 (start date, tenor)
* EUR PAY 1JAN3910Y (forward, tenor)
* EUR PAY 10Y 3M (float)
* EUR PAY 10Y 3M (float) ACT360 (fixed)
* EUR PAY 10Y ATM 3M (float) ACT360 (fixed)
* EURUSD XCCY 10Y
* EURUSD XCCY 10Y 3M RFR
...
.. code-block:: python
    ...
    swaps = na_service.build_swaps("EUR PAY 10Y")
